        ...
        <div className='ml-4 mr-4'>
          ...
          <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {prof.map((person) => (
                  <tr key={person.id}>
                    <td className="px-6 text-left whitespace-nowrap text-sm font-medium text-gray-900">{person.number}</td>
                    <td className="px-6 text-center whitespace-nowrap text-sm text-gray-500">{person.type}</td>
                    <td className="px-6 text-center whitespace-nowrap text-sm text-gray-500">{person.status}</td>
                    <td className="px-6 text-center whitespace-nowrap text-sm text-gray-500">{person.debt}</td>
