...
export default function Appeals() {
  let complexes = [
    {id: 1, adress:"Город Иваново, улица ленинина дом 54 корпус 2", device:"Д6", contract:"Активный", volume: "10 440.00 руб.", plan: "2323"},
  ...
  return (
    <div className='flex flex-col w-full bg-white rounded gazprom-shadow h-73'>
        <div className='w-full flex justify-center rounded-t-lg gazprom-head'>Обращения и заявки</div>
        <div className='ml-4 mr-4'>
          ...
          <table className="min-w-full divide-y divide-gray-200 table-fixed">
            ...
            <div className="flex justify-end mt-2">
                <div className="mr-2">
                    <button className="btn btn-blue mt-2 mb-2 gazprom-button">Создать обращение</button>
                </div>
                <div>
                    <button className="btn btn-blue mt-2 mb-2 mr-10 gazprom-button">Создать заявку</button>
                </div>
            </div>
        </div>
    </div>
