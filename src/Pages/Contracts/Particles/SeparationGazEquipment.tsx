...
import './separationGazEquipment.css';
      ...
      <div className="ml-4 mr-4">
        <div className="mt-1 mb-5">
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <div className='flex ml-6 mt-2'>
                            ...
                            <input type="text" className='p-0.5 ml-4' value={elem.year}/>
                        </div>
                      </p>
                    </Disclosure.Panel>
                  </>
          ...
          <div className="flex justify-end mt-2">
                <div className="mr-2">
                    <button className="btn btn-blue mt-2 mb-2 gazprom-button">Редактировать план</button>
                </div>
                <div>
                    <button className="btn btn-blue mt-2 mb-2 mr-10 gazprom-button">Согласовать неравномерность</button>
                </div>
            </div>
        </div>
      </div>
