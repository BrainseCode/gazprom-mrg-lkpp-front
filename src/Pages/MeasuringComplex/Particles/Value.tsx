...
export default function Value() {
  ...
  let complexes = [
    ...
    {id: 2, date:"22.06.23", source:"ЛК",  volume: "746 647", plan: "565 323", status: "Активно"},
    {id: 3, date:"22.06.23", source:"ЛК",  volume: "746 647", plan: "565 323", status: "Активно"},
    {id: 4, date:"22.06.23", source:"ЛК",  volume: "746 647", plan: "565 323", status: "Активно"},
  ...
  return (
    <div className="flex flex-col w-full bg-white rounded gazprom-shadow h-73">
      ...
      <div className="flex justify-between mt-5">
            ...
            <div className='flex'>
              <div className="ml-2">
                <button className="btn btn-blue gazprom-button" onClick={valueClient}>
                  Передать показания
                </button>
              </div>
            </div>
          ...
          <table className="min-w-full divide-y divide-gray-200 table-fixed">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {complexes.map((complexe) => (
                  <tr key={complexe.id}>
                    <td className="px-6 pt-4 pb-4 text-left whitespace-nowrap text-sm font-medium text-gray-900">{complexe.date}</td>
                    <td className="px-6 pt-4 pb-4 text-center whitespace-nowrap text-sm text-gray-500">{complexe.source}</td>
                    <td className="px-6 pt-4 pb-4 text-center whitespace-nowrap text-sm text-gray-500">{complexe.volume}</td>
                    <td className="px-6 pt-4 pb-4 text-center whitespace-nowrap text-sm text-gray-500">{complexe.plan}</td>
                    <td className="px-6 pt-4 pb-4 text-right whitespace-nowrap text-sm text-gray-500">{complexe.status}</td>
                  </tr>
                ))}
              </tbody>
            </table>      
