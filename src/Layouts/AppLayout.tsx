...
let navigation = [
  ...
  { id: 5, name: 'Измерительные комплексы', href: '/measuringComplex', icon: InboxIcon, current: false },
  { id: 6, name: 'Архив калорийности', href: '/calorieArchive', icon: ChartBarIcon, current: false },
  { id: 7, name: 'Обращения и заявки', href: '/userApplications', icon: InboxIcon, current: false },
  { id: 8, name: 'Тех.поддержка', href: '/technicalSupport', icon: InboxIcon, current: false },
  { id: 9, name: 'Настройки', href: '/settings', icon: InboxIcon, current: false },
]

if(roleUser===1) {
  navigation = [
    { id: 1, name: 'Обработка заявок', href: '/petition', icon: InboxIcon, current: true },
    { id: 2, name: 'Управление аккаунтами', href: '/managementUser', icon: InboxIcon, current: true },
    ...navigation
  ];
}
else if(roleUser===2) {
        ...
        <div className="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-white pt-5">
          <div className="flex flex-shrink-0 items-center px-4">
            ...
            <img
              ...
              alt="Газпром"
            />
            <span className='ml-4'>Газпром Межрегионгаз Иваново</span>
            </Link>
          </div>
